...
- [ ] 6.2 archive 阶段：将 ADDED 全部写入新主 spec `openspec/specs/homepage-hot-posts/spec.md`
- [ ] 6.3 移动 change 目录到 `openspec/changes/archive/<YYYY-MM-DD>-homepage-hot-posts/`
- [ ] 6.4 父仓提交归档：`chore(openspec): archive homepage-hot-posts`
